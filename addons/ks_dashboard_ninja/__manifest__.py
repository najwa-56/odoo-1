...
""",
    ...
    'assets': {
        ...
        'ks_dashboard_ninja.dn_dark_mode': [
            'ks_dashboard_ninja/static/src/scss/variable.dark.scss',
            'ks_dashboard_ninja/static/src/scss/common.dark.scss',
            'ks_dashboard_ninja/static/src/scss/generate_ai.dark.scss',
        ],
        'web.assets_backend': [
            ...
            'ks_dashboard_ninja/static/src/scss/overview_main.scss',
