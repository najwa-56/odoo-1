...
export class KSDashboardNinjaOverview extends Component{
    setup(){
        ...
        onWillStart(async () => {
            this.data = await jsonrpc("/web/dataset/call_kw/ks_dashboard_ninja.board/fetch_dashboard_overview",{
                                model: 'ks_dashboard_ninja.board',
                                method: 'fetch_dashboard_overview',
                                args: [[]],
                                kwargs:{},
                            });
            await jsonrpc("/web/dataset/call_kw/ks_dashboard_ninja.board/ks_update_menu_id",{
                                model: 'ks_dashboard_ninja.board',
