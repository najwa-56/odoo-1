...
class product_product(models.Model):
    ...
    pos_multi_barcode = fields.One2many('pos.multi.barcode','product_id',string='الباركود المتعدد الاساسي')
    pos_multi_barcode_list = fields.Text(string='الباركود المتعدد الاساسي',compute="_compute_multi_barcode")
