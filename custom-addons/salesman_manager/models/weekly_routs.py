...
class WeeklyRouts(models.Model):
    ...
    creation_date = fields.Date(string="تاريخ الإنشاء", default=lambda self: fields.Date.today())
    ...
    Starting_date = fields.Date(string="تاريخ البداية") # the record should be showun in this date
    Ending_date = fields.Date(string="تاريخ النهاية")   # the record should be disapear in this date
