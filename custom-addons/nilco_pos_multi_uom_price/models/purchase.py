...
class PurchaseOrderLine(models.Model):
    ...
    product_uom_id_domain = fields.Char(compute="_compute_uom_domain")
    
    @api.depends('product_id')
    def _compute_uom_domain(self):
        for rec in self:
            uom_ids = rec.product_id.multi_uom_price_id.mapped('uom_id').ids
    ...
    #             'unit_name':self.purchase_multi_uom_id.name_field
    #         }
    #         self.update(values)
