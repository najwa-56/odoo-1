...
class PosOrderLine(models.Model):
    ...
    uom_price_id = fields.Many2one('product.multi.uom.price', string="UOM Price")
    name_field = fields.Char(related='uom_price_id.name_field', string="Name Field", store=True)
    #Edit----#
