...
import { DB } from '@point_of_sale/app/store/db'; // Corrected import
...
patch(Order.prototype, {
    ...
    set_pricelist(pricelist) {
        ...
        // Handle combo_children_lines if needed
    },
});
            ...
            if (quant > 0) {
                ...
                if (!this.comboParent) {
                    this.env.services.popup.add(ErrorPopup, {
                        ...
                        body: _t("The requested quantity to be refunded is higher than the refundable quantity of %s.", this.env.utils.formatProductQty(maxQtyToRefund)),
                    });
                }
                return false;
            }
