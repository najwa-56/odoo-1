...
patch(Orderline.prototype, {
    ...
    export_as_JSON() {
        ...
        json.product_uom_id = this.product_uom_id ? this.product_uom_id[0] : null;
        return json;
    },
    ...
    get_unit() {
        if (this.product.default_uom_price > 0 && this.price_type === "original" && this.product.default_uom_id) {
