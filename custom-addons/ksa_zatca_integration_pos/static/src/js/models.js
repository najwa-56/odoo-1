...
patch(Order.prototype, {
	...
	setup(_defaultObj, options) {
        super.setup(...arguments);
			this.is_invoice_b2b = false;
			this.is_invoice_b2c = false;
			this.is_no_invoice = true;
        
    },
    init_from_JSON(json) {
        super.init_from_JSON(...arguments);
		this.is_invoice_b2b = json.is_invoice_b2b || false;
		this.is_invoice_b2c = json.is_invoice_b2c || false;
		this.is_no_invoice = json.is_no_invoice || true;
		
		this.credit_debit_reason = json.credit_debit_reason || "مرتجع عميل";
    },

	export_as_JSON() {
        const json = super.export_as_JSON(...arguments);
        json.is_invoice_b2b = this.is_invoice_b2b ? this.is_invoice_b2b : false;
		json.is_invoice_b2c = this.is_invoice_b2c ? this.is_invoice_b2c : false;
		json.is_no_invoice = this.is_no_invoice ? this.is_no_invoice : true;
	...
	*/
	...
	set_to_invoice_b2c(is_invoice_b2c) {
        this.assert_editable();
        this.is_invoice_b2c = is_invoice_b2c;
    },
    is_to_b2c_invoice() {
        return this.is_invoice_b2c;
    },


	set_to_invoice_b2b(is_invoice_b2b) {
        this.assert_editable();
        this.is_invoice_b2b = is_invoice_b2b;
    },
    is_to_b2b_invoice() {
        return this.is_invoice_b2b;
    },


	set_no_invoice(is_no_invoice) {
        this.assert_editable();
        this.is_no_invoice = is_no_invoice;
    },

    is_no_invoice() {
		
        return this.is_no_invoice;
    }
