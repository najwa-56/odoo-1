odoo.define('inv_reports_sharing_for_graph.MyCustomActionCOST',  function (require) {
"use strict";
...
var MyCustomActionCOST = AbstractAction.extend({
    template: 'ProductDashboardCOST',
    cssLibs: [
    ],
    jsLibs: [
    ...
    {
          if (this.searchModelConfig.context.active_model == 'cost.analysis.location')
     {
           var self = this;
...
core.action_registry.add("product_cost_alert", MyCustomActionCOST);
return MyCustomActionCOST
});
