odoo.define('inv_reports_sharing_for_graph.MyCustomActionProductProfit',  function (require) {
"use strict";
...
var MyCustomActionProductProfit = AbstractAction.extend({
    template: 'ProductDashboardProductProfit',
    cssLibs: [
    ],
    jsLibs: [
    ...
    getRandomColor: function () {
       ...
       graph_recent_prod: function() {
        ...
        rpc.query({
                model: 'product.profitability',
                method: 'product_profile_data_js',
    ...
    {
          if (this.searchModelConfig.context.active_model == 'product.profitability')
     {
           var self = this;
...
core.action_registry.add("product_profit_alert", MyCustomActionProductProfit);
return MyCustomActionProductProfit
});
