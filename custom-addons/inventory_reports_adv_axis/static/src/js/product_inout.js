odoo.define('inv_reports_sharing_for_graph.MyCustomActionINOUT',  function (require) {
"use strict";
...
var MyCustomActionINOUT = AbstractAction.extend({
    template: 'ProductDashboardinout',
    cssLibs: [
    ],
    jsLibs: [
    ...
    getRandomColor: function () {
       ...
       graph_recent_prod: function() {
        ...
        rpc.query({
                model: 'product.in.out.stock',
                method: 'product_in_data_js',
    ...
    {
          if (this.searchModelConfig.context.active_model == 'product.in.out.stock')
     {
           var self = this;
...
core.action_registry.add("product_inout_alert", MyCustomActionINOUT);
return MyCustomActionINOUT
});
