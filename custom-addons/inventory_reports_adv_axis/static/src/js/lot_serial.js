odoo.define('inv_reports_sharing_for_graph.MyCustomActionLOT',  function (require) {
"use strict";
...
var MyCustomActionLOT = AbstractAction.extend({
    template: 'ProductDashboardLOT',
    cssLibs: [
    ],
    jsLibs: [
    ...
    {
          if (this.searchModelConfig.context.active_model == 'serial.lot.tracking')
     {
           var self = this;
        ...
        rpc.query({
            ...
            .then(function (result) {
                ...
                data: {
                    ...
                    labels: result.payroll_label,
                    datasets: [{
                        label: 'LOT SERIAL TRACKING report',
                        data: result.payroll_dataset,
                        backgroundColor: bg_color_list,
                        borderColor: bg_color_list,
                        borderWidth: 1,
...
core.action_registry.add("product_lot_alert", MyCustomActionLOT);
return MyCustomActionLOT
});
