odoo.define('inv_reports_sharing_for_graph.MyCustomAction3',  function (require) {
"use strict";
...
var MyCustomAction3 = AbstractAction.extend({
    template: 'ProductDashboardViewAvailibilty',
    cssLibs: [
    ],
    jsLibs: [
    ...
    getRandomColor: function () {
       ...
       graph_recent_prod: function() {
        ...
        rpc.query({
                ...
                method: 'get_filtered_products_js',
                args:[],
            })
    ...
    {
          if (this.searchModelConfig.context.active_model == 'stock.availability')
     {
           var self = this;
...
core.action_registry.add("product_avg", MyCustomAction3);
return MyCustomAction3
});
