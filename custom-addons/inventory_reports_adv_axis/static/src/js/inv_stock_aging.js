odoo.define('inv_reports_sharing_for_graph.MyCustomAction6',  function (require) {
"use strict";
...
var MyCustomAction6 = AbstractAction.extend({
    template: 'ProductDashboardViewAging',
    cssLibs: [
    ],
    jsLibs: [
    ...
    {
          if (this.searchModelConfig.context.active_model == 'stock.aging')
     {
           var self = this;
...
core.action_registry.add("stock_aging", MyCustomAction6);
return MyCustomAction6
});
