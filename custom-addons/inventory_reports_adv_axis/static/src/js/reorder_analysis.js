odoo.define('inv_reports_sharing_for_graph.MyCustomAction7',  function (require) {
"use strict";
...
var MyCustomAction7 = AbstractAction.extend({
    template: 'ProductDashboardViewQwebAnalysis',
    cssLibs: [
    ],
    jsLibs: [
    ...
    getRandomColor: function () {
       ...
       graph_recent_prod: function() {
        ...
        rpc.query({
                model: 'stock.reorder.analysis',
                method: 'stock_reorder_analysis_data_js',
    ...
    {
          if (this.searchModelConfig.context.active_model == 'stock.reorder.analysis')
     {
           var self = this;
...
core.action_registry.add("stock_reorder_analysis", MyCustomAction7);
return MyCustomAction7
});
