odoo.define('inv_reports_sharing_for_graph.MyCustomActionFIFO',  function (require) {
"use strict";
...
var MyCustomActionFIFO = AbstractAction.extend({
    template: 'ProductDashboardFIFO',
    cssLibs: [
    ],
    jsLibs: [
    ...
    {
          if (this.searchModelConfig.context.active_model == 'fifo.valuation')
     {
           var self = this;
...
core.action_registry.add("product_fifo_alert", MyCustomActionFIFO);
return MyCustomActionFIFO
});
