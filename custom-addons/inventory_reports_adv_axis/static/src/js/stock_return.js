odoo.define('inv_reports_sharing_for_graph.MyCustomActionSTOCKRETURN',  function (require) {
"use strict";
...
var MyCustomActionSTOCKRETURN = AbstractAction.extend({
    template: 'ProductDashboardSTOCKRETURN',
    cssLibs: [
    ],
    jsLibs: [
    ...
    {
          if (this.searchModelConfig.context.active_model == 'stock.return')
     {
           var self = this;
...
core.action_registry.add("product_stockreturn_alert", MyCustomActionSTOCKRETURN);
return MyCustomActionSTOCKRETURN
});
