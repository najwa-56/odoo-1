odoo.define('inv_reports_sharing_for_graph.MyCustomAction2',  function (require) {
"use strict";
...
var MyCustomAction2 = AbstractAction.extend({
    template: 'ProductDashboardViewtour',
    cssLibs: [
    ],
    jsLibs: [
    ...
    getRandomColor: function () {
       ...
       graph_recent_prod: function() {
        ...
        rpc.query({
                model: 'stock.inventory.turnover',
                method: 'get_product_details_js',
                args:[],
            })
    ...
    {
          if (this.searchModelConfig.context.active_model == 'stock.inventory.turnover')
     {
           var self = this;
...
core.action_registry.add("product_tourover", MyCustomAction2);
return MyCustomAction2
});
