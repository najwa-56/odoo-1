odoo.define('inv_reports_sharing_for_graph.MyCustomAction11',  function (require) {
"use strict";
...
var MyCustomAction11 = AbstractAction.extend({
    template: 'ProductDashboardViewOverstock',
    cssLibs: [
    ],
    jsLibs: [
    ...
    getRandomColor: function () {
       ...
       graph_recent_prod: function() {
        ...
        rpc.query({
                ...
                method: 'inventory_overstock_data_js',
    ...
    {
          if (this.searchModelConfig.context.active_model == 'inventory.overstock')
     {
           var self = this;
...
core.action_registry.add("inventory_overstock", MyCustomAction11);
return MyCustomAction11
});
