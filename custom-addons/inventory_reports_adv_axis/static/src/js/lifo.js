odoo.define('inv_reports_sharing_for_graph.MyCustomActionLIFO',  function (require) {
"use strict";
...
var MyCustomActionLIFO = AbstractAction.extend({
    template: 'ProductDashboardLIFO',
    cssLibs: [
    ],
    jsLibs: [
    ...
    {
          if (this.searchModelConfig.context.active_model == 'lifo.valuation')
     {
           var self = this;
...
core.action_registry.add("product_lifo_alert", MyCustomActionLIFO);
return MyCustomActionLIFO
});
