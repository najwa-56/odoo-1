odoo.define('inv_reports_sharing_for_graph.MyCustomActionVelocity',  function (require) {
"use strict";
...
var MyCustomActionVelocity = AbstractAction.extend({
    template: 'ProductDashboardvelocity',
    cssLibs: [
    ],
    jsLibs: [
    ...
    getRandomColor: function () {
       ...
       graph_recent_prod: function() {
        ...
        rpc.query({
                model: 'stock.velocity.analysis',
                method: 'velocity_data_js',
    ...
    {
          if (this.searchModelConfig.context.active_model == 'stock.velocity.analysis')
     {
           var self = this;
...
core.action_registry.add("product_velocity_alert", MyCustomActionVelocity);
return MyCustomActionVelocity
});
