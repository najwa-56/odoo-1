odoo.define('inv_reports_sharing_for_graph.MyCustomAction9',  function (require) {
"use strict";
...
var MyCustomAction9 = AbstractAction.extend({
    template: 'ProductDashboardViewForecast',
    cssLibs: [
    ],
    jsLibs: [
    ...
    getRandomColor: function () {
       ...
       graph_recent_prod: function() {
        ...
        rpc.query({
                model: 'stock.forecast',
                method: 'stock_forecast_data_js',
    ...
    {
          if (this.searchModelConfig.context.active_model == 'stock.forecast')
     {
           var self = this;
...
core.action_registry.add("stock_forecast", MyCustomAction9);
return MyCustomAction9
});
