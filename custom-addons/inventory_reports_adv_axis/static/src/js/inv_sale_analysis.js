odoo.define('inv_reports_sharing_for_graph.MyCustomAction5',  function (require) {
"use strict";
...
var MyCustomAction5 = AbstractAction.extend({
    template: 'ProductDashboardViewSaleAnalysis',
    cssLibs: [
    ],
    jsLibs: [
    ...
    getRandomColor: function () {
       ...
       graph_recent_prod: function() {
        ...
        rpc.query({
                ...
                method: 'sale_anaysis_report_data_js',
    ...
    {
          if (this.searchModelConfig.context.active_model == 'sales.analysis')
     {
           var self = this;
...
core.action_registry.add("sale_analysis", MyCustomAction5);
return MyCustomAction5
});
