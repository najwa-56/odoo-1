odoo.define('inv_reports_sharing_for_graph.MyCustomActionXYZ',  function (require) {
"use strict";
...
var MyCustomActionXYZ = AbstractAction.extend({
    template: 'ProductDashboardxyz',
    cssLibs: [
    ],
    jsLibs: [
    ...
    {
          if (this.searchModelConfig.context.active_model == 'xyz.analysis')
     {
           var self = this;
...
core.action_registry.add("product_xyz_alert", MyCustomActionXYZ);
return MyCustomActionXYZ
});
