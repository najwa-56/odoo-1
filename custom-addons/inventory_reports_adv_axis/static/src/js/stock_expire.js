odoo.define('inv_reports_sharing_for_graph.MyCustomAction8',  function (require) {
"use strict";
...
var MyCustomAction8 = AbstractAction.extend({
    template: 'ProductDashboardViewExpire',
    cssLibs: [
    ],
    jsLibs: [
    ...
    {
          if (this.searchModelConfig.context.active_model == 'stock.expiry')
     {
           var self = this;
...
core.action_registry.add("stock_expire", MyCustomAction8);
return MyCustomAction8
});
