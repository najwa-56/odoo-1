odoo.define('inv_reports_sharing_for_graph.MyCustomAction13',  function (require) {
"use strict";
...
var MyCustomAction13 = AbstractAction.extend({
    template: 'ProductDashboardViewCoverage',
    cssLibs: [
    ],
    jsLibs: [
    ...
    getRandomColor: function () {
       ...
       graph_recent_prod: function() {
        ...
        rpc.query({
                ...
                method: 'inventory_coverage_data_js',
    ...
    {
          if (this.searchModelConfig.context.active_model == 'inventory.coverage')
     {
           var self = this;
...
core.action_registry.add("inventory_coverage", MyCustomAction13);
return MyCustomAction13
});
