odoo.define('inv_reports_sharing_for_graph.MyCustomAction4',  function (require) {
"use strict";
...
var MyCustomAction4 = AbstractAction.extend({
    template: 'ProductDashboardViewMovement',
    cssLibs: [
    ],
    jsLibs: [
    ...
    {
          if (this.searchModelConfig.context.active_model == 'stock.movement')
     {
           var self = this;
...
core.action_registry.add("product_movement", MyCustomAction4);
return MyCustomAction4
});
