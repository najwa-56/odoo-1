odoo.define('inv_reports_sharing_for_graph.MyCustomAction10',  function (require) {
"use strict";
...
var MyCustomAction10 = AbstractAction.extend({
    template: 'ProductDashboardViewBalance',
    cssLibs: [
    ],
    jsLibs: [
    ...
    getRandomColor: function () {
       ...
       graph_recent_prod: function() {
        ...
        rpc.query({
                model: 'inventory.balance.sheet',
                method: 'inventory_balance_sheet_data_js',
    ...
    {
          if (this.searchModelConfig.context.active_model == 'inventory.balance.sheet')
     {
           var self = this;
...
core.action_registry.add("inventory_balance_sheet", MyCustomAction10);
return MyCustomAction10
});
