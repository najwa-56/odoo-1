odoo.define('inv_reports_sharing_for_graph.MyCustomActionABC',  function (require) {
"use strict";
...
var MyCustomActionABC = AbstractAction.extend({
    template: 'ProductDashboardABC',
    cssLibs: [
    ],
    jsLibs: [
    ...
    {
          if (this.searchModelConfig.context.active_model == 'inventory.abc.analysis')
     {
           var self = this;
...
core.action_registry.add("product_abc_alert", MyCustomActionABC);
return MyCustomActionABC
});
