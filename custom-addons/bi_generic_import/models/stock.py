...
class gen_inv(models.TransientModel):
    ...
    import_prod_option = fields.Selection([('barcode', 'Barcode'), ('code', 'Code'), ('name', 'Name'),('id', 'id')],
        ...
        if self.import_option == 'csv':
            ...
            for i in range(len(file_reader)):
                if i != 0:
                    ...
                    elif self.import_prod_option == 'id':
                        prod_lst = product_obj.search([('id', '=', values['code'])])
                ...
                if row_no <= 0:
                    ...
                    if line:
                        ...
                        if self.import_prod_option == 'barcode':
                            ...
                            product_id = int(float(values['code']))
                            print("in here================",values['code'] , type(values['code']) , product_id ,type(product_id))
                            prod_lst = product_obj.search([('id', '=', product_id)])
                        ...
                        print("stock_location_id=============",stock_location_id)
                        if not stock_location_id:
