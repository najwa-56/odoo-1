...
class AccountMove(models.Model):
    ...
    def send_invoice_batch(self):
        today = date.today()
        two_days_ago = today - timedelta(days=17)
    ...
    def send_invoice_company3_batch(self):
        today = date.today()
        ...
        if remaining_count > 0:
            self.env.ref('othaim_zatca_integration.ir_cron_send_inovoice_compnay3_job_count')._trigger()
