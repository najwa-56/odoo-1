...
class StockLocation(models.Model):
    ...
    is_inter = fields.Boolean('Inter Source Location?')
    is_inter_dolfin = fields.Boolean('Inter Dolfin Source Location?')
    is_from_inter = fields.Boolean('Inter Destination Location?')
